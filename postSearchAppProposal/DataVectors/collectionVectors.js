...
function readFeedback(error, results){
  if(error){
    console.error('rekt');
  } else {
    console.log(results);
...
// Creation d'une Canva Principal avec retour photo analisées.
// Chargement de poseNet
function setup() {
  createCanvas(640, 480);
// definir photo et itérer sur data importé.
// From local ou API ?
  picture = createImg('7389.jpg',imageResize);
  picture.hide();
  poseNet = ml5.poseNet(picture,readFeedback);
